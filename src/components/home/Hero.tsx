...
export default function Hero() {
    return (
        <section className="relative min-h-[65vh] overflow-hidden  bg-gradient-to-br from-cyan-50 via-white to-blue-100 dark:from-slate-950 dark:via-slate-900 dark:to-slate-950">
            ...
            >
                <a
                    href="#features"
                    className="flex flex-col items-center text-slate-500 hover:text-cyan-600 transition"
                >
                    <span className="mb-2 text-sm font-medium">
                        Scroll Down
                    </span>

                    <div className="rounded-full border border-slate-300 p-2 backdrop-blur-md">
                        <ChevronDown size={22} />
                    </div>
                </a>
            </motion.div>
